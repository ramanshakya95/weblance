                    ...
                    {digital_services_data.map(digital_services => (
                        <Row className='digital_services_row' key={digital_services.id}>
                            <Col className='first_column'>
                                ...
                                <ul>
                                    <li>{digital_services.points_list[0]}</li>
                                </ul>
                            </Col>
